...
python THUMT/thumt/bin/train_decoder.py \
    ...
    --parameters=batch_size=32,constant_batch_size=true,device_list=[0,5],update_cycle=2,keep_checkpoint_max=5,eval_steps=1000,train_steps=200000

# --input encmodel/enc_output_5m.tfrecords data/corpus.tc.32k.de.shuf \
# --output de-decoder-model/5m \
# --input encmodel/enc_output.tfrecords data/corpus.tc.32k.10w.de.shuf \
# --output de-decoder-model/10w \
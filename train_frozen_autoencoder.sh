...
python THUMT/thumt/bin/train_frozen_autoencoder.py \
    ...
    --parameters=batch_size=6250,constant_batch_size=false,device_list=[3,4],update_cycle=2,keep_checkpoint_max=5,eval_steps=1000,beam_size=4,decode_alpha=1.4,train_steps=200000

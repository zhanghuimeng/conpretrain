...
python THUMT/thumt/bin/train_enc_and_dec.py \
    ...
    --output en-de-concat-model/prac-small \
    ...
    --parameters=batch_size=6250,constant_batch_size=false,device_list=[0,1],update_cycle=2,keep_checkpoint_max=5,eval_steps=500,beam_size=4,decode_alpha=1.4,train_steps=200000,adapt_mode=small-random
